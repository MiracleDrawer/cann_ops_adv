...
function(op_add_subdirectory OP_LIST OP_DIR_LIST ALL_OP_DIR_LIST)
    set(_OP_LIST)
    set(_OP_DIR_LIST)
    set(_ALL_OP_DIR_LIST)

    file(GLOB OP_HOST_CMAKE_FILES "${CMAKE_CURRENT_SOURCE_DIR}/src/**/**/ophost/CMakeLists.txt")
    ...
    foreach(OP_CMAKE_FILE ${OP_HOST_CMAKE_FILES})
        ...
        list(APPEND _ALL_OP_DIR_LIST ${OP_DIR})
    ...
    list(REMOVE_DUPLICATES _ALL_OP_DIR_LIST)
    set(${OP_LIST} ${_OP_LIST} PARENT_SCOPE)
    set(${OP_DIR_LIST} ${_OP_DIR_LIST} PARENT_SCOPE)
    set(${ALL_OP_DIR_LIST} ${_ALL_OP_DIR_LIST} PARENT_SCOPE)
endfunction()
...
function(add_ops_src_copy)
    ...
    if (NOT TARGET ${SRC_COPY_TARGET_NAME})
        ...
        add_custom_command(OUTPUT ${_BUILD_FLAG}
                ...
                COMMAND cp -rf ${SRC_COPY_SRC}/*.* ${SRC_COPY_DST}
