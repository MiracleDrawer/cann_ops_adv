...
int main(int argc, char **argv)
{
    ...
    // 如果需要修改shape值，需要同步修改../scripts/ffn_generate_data.py中 test_ffn 分支下生成
    ...
    // 调用aclnnFFN第一段接口
    ret = aclnnFFNGetWorkspaceSize(params.x, params.weight1, params.weight2, params.expertTokens, params.bias1,
                                   ...
                                   params.antiquantOffset2, activation, innerPrecise, params.y, &workspaceSize,
                                   &executor);
    ...
    // 调用aclnnFFN第二段接口
    ret = aclnnFFN(addrs.workspaceAddr, workspaceSize, executor, stream);
