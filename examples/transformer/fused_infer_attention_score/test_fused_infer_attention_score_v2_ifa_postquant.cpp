...
/*!
 * \file test_fused_infer_attention_score_v2_ifa_postquant.cpp
 * \brief
 */
...
int main()
{
    ...
    std::vector<uint16_t> valueHostData(valueShapeSize, 0xC300);
    std::vector<float> attenHostData(attenShapeSize, 1);
    std::vector<int8_t> outHostData(outShapeSize, 1);
    ...
    ret = CreateAclTensor(quantScale2HostData, quantScale2Shape, &quantScale2DeviceAddr, aclDataType::ACL_FLOAT,
                          &quantScale2Tensor);
    CHECK_RET(ret == ACL_SUCCESS, return ret);
    ...
    ret = aclnnFusedInferAttentionScoreV2GetWorkspaceSize(
        ...
        quantScale2Tensor, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr,
        nullptr, nullptr, nullptr, numHeads, scaleValue, preTokens, nextTokens, &sLayerOut[0], numKeyValueHeads, sparseMode,
