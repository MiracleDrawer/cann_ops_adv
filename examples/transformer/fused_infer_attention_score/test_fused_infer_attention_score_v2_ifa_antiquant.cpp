...
int main() {
  ...
  CHECK_RET(ret == ACL_SUCCESS, return ret);
  //antiquant params
  ret = CreateAclTensor(keyAntiquantScaleHostData, keyAntiquantScaleShape, &keyAntiquantScaleDeviceAddr, aclDataType::ACL_FLOAT16, &keyAntiquantScaleTensor);
  CHECK_RET(ret == ACL_SUCCESS, return ret);
  ret = CreateAclTensor(keyAntiquantOffsetHostData, keyAntiquantOffsetShape, &keyAntiquantOffsetDeviceAddr, aclDataType::ACL_FLOAT16, &keyAntiquantOffsetTensor);
  CHECK_RET(ret == ACL_SUCCESS, return ret);
  ret = CreateAclTensor(valueAntiquantScaleHostData, valueAntiquantScaleShape, &valueAntiquantScaleDeviceAddr, aclDataType::ACL_FLOAT16, &valueAntiquantScaleTensor);
  CHECK_RET(ret == ACL_SUCCESS, return ret);
  ret = CreateAclTensor(valueAntiquantOffsetHostData, valueAntiquantOffsetShape, &valueAntiquantOffsetDeviceAddr, aclDataType::ACL_FLOAT16, &valueAntiquantOffsetTensor);
  CHECK_RET(ret == ACL_SUCCESS, return ret);
