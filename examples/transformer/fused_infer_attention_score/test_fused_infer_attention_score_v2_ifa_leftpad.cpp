...
/*!
 * \file test_fused_infer_attention_score_v2_ifa_leftpad.cpp
 * \brief
 */
...
int main() {
  ...
  std::vector<int64_t> kvPaddingSizeShape = {1}; 
  void *queryDeviceAddr = nullptr;
  void *keyDeviceAddr = nullptr;
  void *valueDeviceAddr = nullptr;
  void *attenDeviceAddr = nullptr;
  void *outDeviceAddr = nullptr;
  void *kvPaddingSizeDeviceAddr = nullptr;
  aclTensor *queryTensor = nullptr;
  aclTensor *keyTensor = nullptr;
  aclTensor *valueTensor = nullptr;
  aclTensor *attenTensor = nullptr;
  aclTensor *outTensor = nullptr;
  aclTensor *kvPaddingSizeTensor = nullptr;
  ...
  int64_t kvPaddingSizeShapeSize = GetShapeSize(kvPaddingSizeShape);
  ...
  std::vector<int64_t> kvPaddingSizeHostData(kvPaddingSizeShapeSize, 0);
  ...
  CHECK_RET(ret == ACL_SUCCESS, return ret);
  ret = CreateAclTensor(kvPaddingSizeHostData, kvPaddingSizeShape, &kvPaddingSizeDeviceAddr, aclDataType::ACL_INT64, &kvPaddingSizeTensor);
  CHECK_RET(ret == ACL_SUCCESS, return ret);
  ...
  ret = aclnnFusedInferAttentionScoreV2GetWorkspaceSize(queryTensor, tensorKeyList, tensorValueList,  nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, kvPaddingSizeTensor, nullptr, nullptr, nullptr, nullptr,
  ...
  aclrtFree(kvPaddingSizeDeviceAddr);
  if (workspaceSize > 0) {
