...
#define INVOKE_PFA_GENERAL_OP_IMPL(templateClass, ...)                                                                  \
    do {                                                                                                                \
        ...
        op.Init(query, key, value, pseShift, attenMask, actualSeqLengths, actualSeqLengthsKV, queryPaddingSize,         \
                kvPaddingSize, attentionOut, softmaxLse, user, tiling_data, &tPipe);                                    \
        op.Process();                                                                                                   \
    } while (0)
...
extern "C" __global__ __aicore__ void prompt_flash_attention_FIAS(__gm__ uint8_t* query, __gm__ uint8_t* key, __gm__ uint8_t* value,
                                                             ...
                                                             __gm__ uint8_t* antiquant_offset, __gm__ uint8_t* queryPaddingSize,
                                                             ...
                                                             __gm__ uint8_t* workspace, __gm__ uint8_t* tiling)
{
    prompt_flash_attention_FIAS(query, key, value, pseShift, attenMask, actualSeqLengths, actualSeqLengthsKV, deq_scale1, quant_scale1, deq_scale2, quant_scale2,
                                quant_offset2, nullptr, nullptr, nullptr, nullptr, attentionOut, nullptr, workspace, tiling);
}