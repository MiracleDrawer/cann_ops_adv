...
const auto Tc_FFN_Aclnn_Case = ::testing::Values(
    ...
    AclnnFFNCase("Test_009", true,                                        /* CaseName,Enable */
                 "",                                                      /* DebugInfo */
                 OpInfo(ControlInfo(true, true),                          /* RunTiling,RunKernel */
                        ExpectInfo(true,                                  /* ExpectSuccess */
                                   ExpectInfo::kInvalidTilingKey,         /* ExpectTilingKey */
                                   ExpectInfo::kInvalidTilingBlockDim)),  /* ExpectTilingBlockDim */
                 AclnnFFNParam({GenTensor("x", {256, 512}, ge::DataType::DT_INT8),
                                GenTensor("weight1", {512, 256}, ge::DataType::DT_INT8),
                                GenTensor("weight2", {256, 512}, ge::DataType::DT_INT8),
                                GenTensor("bias1", {256}, ge::DataType::DT_INT32), GenTensor("bias2", {512}, ge::DataType::DT_INT32),
                                GenTensor("scale", {1}, ge::DataType::DT_FLOAT), GenTensor("offset", {1}, ge::DataType::DT_FLOAT),
                                GenTensor("deqScale1", {256}, ge::DataType::DT_BF16),
                                GenTensor("deqScale2", {512}, ge::DataType::DT_BF16),
